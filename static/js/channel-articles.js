...
function dispIconsLink() {
	...
	if (urlParams["SID"] != "" && urlParams["SID"] != undefined) {
		innerHTML = "<a href='/slides?TYPE=SLIDE&DOC_ID=" + urlParams["DOC_ID"] + "&SID=" + urlParams["SID"] + "&FORCE=" + "Y" + "' target='slideMe' ><img src='/img/ulapph-icons-slides.png' width=100 height=100 title='Slide View'></img></a> <a href='/share?SH_FUNC=all&title=" + title + "&url=" + res + "' target='shareme'><img src='/img/sharethis.png' width=100 height=100 title='Share to social networks'></img></a>";

...
function channelConnect() {
	...
	if (es.value == "STEP1") {
		e.innerHTML += "<img src='/img/loading.gif' width=60 height=60></img><br><!--Copy the passcode below & click enter passcode--><br>";
		var str = tu.value;
		var res = str.replace(/&/g, "@888@");
		e.innerHTML += "<a href=\"/message-channel?CHAN_FUNC=authPasscode&mode=qr" + "&TID=" + et.value + "&UID=TEMP" + ea.value + "&CID=" + el.value + "&target-url=" + res + "\"><img src=\"/img/pointer.gif\"><!--Click Here to Enter Passcode--> Please wait... you will be redirected to the desktop...</a><br>";
		
	} else if (es.value == "guest1") {
		e.innerHTML += "<img src='/img/loading.gif' width=60 height=60></img><br><!--Copy the passcode below & click enter passcode--><br>";
		var str = tu.value;
		var res = str.replace(/&/g, "@888@");
		e.innerHTML += "<a href=\"/message-channel?CHAN_FUNC=authPasscode2&mode=guest" + "&TID=" + et.value + "&UID=TEMP" + ea.value + "&CID=" + el.value + "&target-url=" + res + "\"><h3><img src=\"/img/pointer.gif\"><!--Click Here to Enter Passcode--> Please wait... you will be redirected to the desktop...</h3></a><br>";

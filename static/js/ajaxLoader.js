		...
		$(window).load(function(){
		 $(window).scroll(function() {   
		   if($(window).scrollTop() + $(window).height() > $(document).height() - 100) {
				...
				switch (s.value) {
					case "0":
						load_ajax_url = "/contents?q=LOAD_AJAX_TILES&tbl_src=TDSSLIDE&deskName=" + d.value + "&cursor=1";
						s.value = "1";
						...
						break;
					case "1":
						load_ajax_url = "/contents?q=LOAD_AJAX_TILES&tbl_src=TDSSLIDE&deskName=" + d.value + "&cursor=2";
						s.value = "2";
						if (window.XMLHttpRequest)
						  {// code for IE7+, Firefox, Chrome, Opera, Safari
				...
				switch (a.value) {
					case "0":
						load_ajax_url2 = "/contents?q=LOAD_AJAX_TILES&tbl_src=TDSARTL&deskName=" + d.value + "&cursor=1";
						a.value = "1";
						if (window.XMLHttpRequest)
						  {// code for IE7+, Firefox, Chrome, Opera, Safari
						...
						break;
					case "1":
						load_ajax_url2 = "/contents?q=LOAD_AJAX_TILES&tbl_src=TDSARTL&deskName=" + d.value + "&cursor=2";
						a.value = "2";
						if (window.XMLHttpRequest)
						  {// code for IE7+, Firefox, Chrome, Opera, Safari

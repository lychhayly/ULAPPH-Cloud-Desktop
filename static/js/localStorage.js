...
function getIconSrc(thisStr) {
	switch (thisStr) {
		case "ARTICLE":
			ival = '<img src="/img/ulapph-icons-articles.png" width=30 height=30>';
			break;
		case "SLIDE":
			ival = '<img src="/img/ulapph-icons-slides.png" width=30 height=30>';
			break;
		case "TEXT":
			ival = '<img src="/img/text-icon.gif" width=30 height=30>';
			break;
		case "IMAGE":
			ival = '<img src="/img/image-icon.png" width=30 height=30>';
			break;
	}
	return ival;
}

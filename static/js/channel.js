...
if (typeof(e) != 'undefined' && e != null) {
	e.innerHTML = "<a href='/infodb?DB_FUNC=ULAPPH-NOTIFICATIONS-LOG&SID=ULAPPH-NOTIFICATIONS-LOG' target='notifications'><img src='/img/channel-connected.png' width=90 height=90></img></a>CHANNEL CONNECTED.<a href=\"https://mail.google.com\" target=\"gm\"><img src=\"/img/Gmail.png\" width=\"90\" height=\"90\" align=\"right\"></a><a href=\"https://www.linkedin.com\" target=\"li\"><img src=\"/img/linkedin-icon.png\" width=\"90\" height=\"90\" align=\"right\"></a><a href=\"https://www.twitter.com\" target=\"tw\"><img src=\"/img/twitter-icon.png\" width=\"90\" height=\"90\" align=\"right\"></a><a href=\"https://www.facebook.com\" target=\"fb\"><img src=\"/img/facebook-icon.png\" width=\"90\" height=\"90\" align=\"right\"></a><a href=\"https://plus.google.com\" target=\"gp\"><img src=\"/img/icon-comm.png\" width=\"90\" height=\"90\" align=\"right\"></a><iframe src=\"https://www.thetimenow.com/clock/utc/coordinated_universal_time?t=n&embed=1&text=15&textdate=15&format=24&digitalclock=36&analogclock=60&letter_spacing=-2&bordersize=1&bordercolor=BCE2F7&bgcolor=EBF8FF&colorloc=000000&colordigital=2C8EBF&colordate=000000&styleloc=normal&styledigital=normal&styledate=normal&right=0\" width=\"250\" height=\"100\" scrolling=\"no\" align=\"right\"></iframe><iframe src=\"https://oras.pagasa.dost.gov.ph/widget.shtml\" width=300 height=90 scrolling=no align=\"right\"></iframe>";
	alertifyThis("Launch Window Manager!<br><a href=\"/uwm\"><img src=\"/img/jswm.png\" width=200 height=200></a>");
}
...
function onError(err) {
	var e = document.getElementById("channel-area");
	if (typeof(e) != 'undefined' && e != null) {
	e.innerHTML = "<a href='/infodb?DB_FUNC=ULAPPH-NOTIFICATIONS-LOG&SID=ULAPPH-NOTIFICATIONS-LOG' target='notifications'><img src='/img/channel-error.png' width=90 height=90></img></a></a>CHANNEL ERROR.";
	}
...
function onClose() {
	var e = document.getElementById("channel-area");
	if (typeof(e) != 'undefined' && e != null) {
	e.innerHTML = "<a href='/infodb?DB_FUNC=ULAPPH-NOTIFICATIONS-LOG&SID=ULAPPH-NOTIFICATIONS-LOG' target='notifications'><img src='/img/channel-disconnected.png' width=90 height=90></img></a>CHANNEL DISCONNECTED.";
	}
	window.location.assign("/?q=home");
};

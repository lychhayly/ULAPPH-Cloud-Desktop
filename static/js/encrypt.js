...
function encryptDataAll() {
	...
	if (SPL.length > 0) {
		for (var i = 0, len = SPL.length; i < len; i++) {
			...
			if (SPL[i] !== "" && SPL[i] != undefined && SPL[i] != "undefined") {
				console.log(SPL[i]);
				ctr++;
				e.innerHTML = e.innerHTML + "<img src=\"/img/encrypted.png\" width=\"50\" height=\"50\">";
	...
	if (ctr > 0) {
		e.innerHTML = "<img src=\"/img/encrypted2.png\" width=\"50\" height=\"50\">All " + ctr + " files are now encrypted!";
	}
	return;
};

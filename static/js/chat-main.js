...
$(function() {
	...
	if (res[0] == "/") {
		...
		if (resa[0] == "/ringtone" || resa[0] == "/Ringtone") {
			if (resa.length == 2) {
				...
				switch (resa[1]) {
					case "1":
						tval = "/audio/beepbeep.ogg";
						tval2 = "/audio/beepbeep.mp3";
						break;
					case "2":
						tval = "/audio/bloo.ogg";
						tval2 = "/audio/bloo.mp3";
						break;
					case "3":
						tval = "/audio/kewl.ogg";
						tval2 = "/audio/kewl.mp3";
						break;
					case "4":
						tval = "/audio/yawn.ogg";
						tval2 = "/audio/yawn.mp3";
						break;
					case "5":
						tval = "/audio/jamesbrown.ogg";
						tval2 = "/audio/jamesbrown.mp3";
						break;
				}
				if (tval != "") {
  ...
  $inputMessage.click(function () {
	...
	function onError(err) {
		soundNow();
		innerHTML = "<a href='/infodb?DB_FUNC=ULAPPH-NOTIFICATIONS-LOG&SID=ULAPPH-NOTIFICATIONS-LOG' target='notifications'><img src='/img/channel-error.png' width=60 height=60></img></a></a>CHANNEL ERROR. <br>[<a href='/stream?STR_FUNC=DEL_CHAN&UID=" + aUser.value + "'>Reset Channel</a>]";
		alertifyThis(innerHTML);
		addChatMessage({
			username: "ULAPPH:",
	...
	function onClose() {
		soundNow();
		innerHTML = "<a href='/infodb?DB_FUNC=ULAPPH-NOTIFICATIONS-LOG&SID=ULAPPH-NOTIFICATIONS-LOG' target='notifications'><img src='/img/channel-disconnected.png' width=60 height=60></img></a>CHANNEL DISCONNECTED. <br>[<a href='/stream?STR_FUNC=DEL_CHAN&UID=" + aUser.value + "'>Reset Channel</a>]";
		alertifyThis(innerHTML);
		addChatMessage({
			username: "ULAPPH:",

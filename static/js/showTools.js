function showTools() {
	...
	switch (i.value) {
		case "set1":
			i.value = "set2";
			e.innerHTML = '<center>' +
			'<a href="/people"><img src="/img/ulapph-icons-people-icon.png" title="people" height="50" width="50"></img></a>' +
			'<a href="/chat"><img src="/img/chat.png" title="chat" height="50" width="50"></img></a>' +
			'<a href="/search" title="Search ULAPPH"><img src="/img/search-icons.png" height="50" width="50"/></a>' +
			...
			'<a href="/uloc">' +
			'	<img src="/img/uloc.png" title="Local Storage" height="50" width="50"></a>' +
			...
			'<a href="/?q=qm#upload-music"><img src="/img/new-music.png" title="Upload Music" height="50" width="50"></a>' +
			'<a href="/?q=qv#upload-video"><img src="/img/new-video.png" title="Upload Video" height="50" width="50"></a>' +
			'<a href="/media?FUNC_CODE=UMP"><img src="/img/music-player.png" title="Music Player" height="50" width="50"></a>' +
			'<a href="/media?FUNC_CODE=UVP"><img src="/img/video-player.png" title="Video Player" height="50" width="50"></a>' +
			'<a href="/media?FUNC_CODE=YVP"><img src="/img/youtube-player.png" title="Youtube Player" height="50" width="50"></a>' +
			'<a href="/infodb?DB_FUNC=MEDIA&CATEGORY=ALL_TEXTS"><img src="/img/all-text.png" title="Show All Texts" height="50" width="50"></a>' +
					'<a class="button-secondary pure-button" href="" onclick="showTools();return false;">' +
						'<img src="/img/arrow-green.png" title="More tools..." height="40" width="40"></a>' +
			'</center>';				
			break;
		case "set2":
			i.value = "set3";

...
function onOpen() {
	...
	var el = document.getElementById("chan-id");
	var e = document.getElementById("channel-area");
	e.innerHTML = "<a href='/infodb?DB_FUNC=ULAPPH-NOTIFICATIONS-LOG&SID=ULAPPH-NOTIFICATIONS-LOG' target='notifications'><img src='/img/channel-connected.png' width=90 height=90></img></a>CHANNEL CONNECTED.";
